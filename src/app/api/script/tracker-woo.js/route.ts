/**
 * GET /api/script/tracker-woo.js?store_id=<uuid>
 *
 * Serves the WooCommerce front-end tracker as application/javascript with a
 ...
 *
 * Source lives at public/tracker-woo.js so it can also be inspected directly
...
const SCRIPT_PATH = join(process.cwd(), 'public', 'tracker-woo.js');
